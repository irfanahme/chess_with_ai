# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 16:45:30 2020
    ...
    with tf.device('/gpu:1'):
        with tf.name_scope("predict_actions"):
          ...
          with tf.variable_scope("q_network", reuse=False):
            self.q_outputs = self.q_network(self.states, myscope = "q_network")
    ...
    #      self.next_states = tf.placeholder(tf.float32, (None,self.state_dim), name="next_states")
          ...
          if self.double_q_learning:
            ...
            with tf.variable_scope("q_network", reuse=tf.AUTO_REUSE):
              self.q_next_outputs = self.q_network(self.next_states , myscope = "q_network")
            ...
            with tf.variable_scope("target_network"):
              self.target_outputs = self.q_network(self.next_states, myscope = "target_network") * tf.cast(self.action_selection_mask, tf.float32)
            ...
            with tf.variable_scope("target_network"):
              self.target_outputs = self.q_network(self.next_states, myscope = "target_network")

# -*- coding: utf-8 -*-
"""
Created on Fri Feb 14 11:46:15 2020
...
try:
    from tf.keras.layers import Dense,  Conv2D, Add, Flatten, BatchNormalization
    from tf.keras.layers import   LeakyReLU,Activation
    from tf.keras import regularizers
except:
    from tensorflow.keras.layers import Dense,  Conv2D, Add, Flatten, BatchNormalization
...
def  creat_network_3d(state, myscope, state_shape= [-1, 18, 8, 8],residual_tower = 16, 
    ...
    with tf.variable_scope(myscope): 
        ...
        value = Dense(units=1, use_bias=False, activation='tanh', 
                          kernel_regularizer=regularizers.l2(reg_const), name='value_head')(block)
